...
% 
ebno_sp = [3, 4, 4.5, 4.6, 4.7, 4.8, 4.9, 5];
time_sp_50 = [6.21475e+09, 6.17265e+09, 6.03251e+09, 5.04901e+09, 2.60614e+09,  1.39746e+09, 1.07678e+09, 9.03046e+08]./1e9;
time_sp_100 = [1.06808e+10, 1.05435e+10, 1.01902e+10, 7.64292e+09, 2.64309e+09, 1.26275e+09, 9.9787e+08, 9.39012e+08]./1e9;

figure,
stem(1:length(time_sp_50), time_sp_50, '-^'), hold on,
stem(1:length(time_sp_100), time_sp_100, '-^'), hold on,
grid on
xlabel('EBN0 [dB]')
ylabel('T [s]')
legend('Sum Product, 50', 'Sum Product, 100')
